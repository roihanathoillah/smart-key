        ...
        <div class="form-wrap">
            ...
            <form id="registerForm" action="{{ url('/register') }}" method="POST">
                ...
                <div class="field">
                    ...
                    >
                    @error('name')
                        <div class="error" style="color:#c00;font-size:13px">
                            {{ $message }}
                        </div>
                    @enderror
                </div>
            ...
            <div class="socials">
                <a class="social" href="#" aria-label="Facebook">
                    <img
                        src="/images/facebook-logo-facebook-social-media-icon-free-png.png"
                        alt="Facebook"
                    >
                </a>
                ...
                <a class="social" href="#" aria-label="Apple">
                    <img
                        src="/images/icons8-apple-inc-24.png"
                        alt="Apple"
                    >
                </a>
            </div>
